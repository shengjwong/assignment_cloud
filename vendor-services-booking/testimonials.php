...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($vendor_id < 1 || $comment === '' || $rating < 1 || $rating > 5) {
        ...
        $stmt = $conn->prepare(
            'INSERT INTO testimonials (user_id, vendor_id, comment, rating)
             VALUES (?, ?, ?, ?)'
        );
...
<div class="container">
    ...
    <div class="page-header">
        <h1>Testimonials</h1>
        <p>
            What clients are saying about GUGUGAGA vendor services.
        </p>
    </div>

    <?php if (current_user_id()): ?>

        <div class="form-card testimonial-form-card">
