...
<div class="container">
    ...
    <section class="hero">
        ...
        <p>
            Easily book appointments with top-rated local printing,
            laundry, tailoring, and tech repair vendors.
        </p>
    </section>
            ...
            <table>
                ...
                <?php foreach ($myBookings as $b): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= number_format($b['estimated_total'], 2) ?>
                        </td>
